...
The configuration-space observations are sensitive to the mass, age, impact parameter, and total velocity of the encounter, and future velocity-space observations will be sensitive to the full velocity vector of the perturber.
...
The Milky Way is surrounded by $\sim60$ dwarf galaxies \citep{mcconnachie2012} and $\sim160$ globular clusters \citep{harris2010}, most of which, same as GD-1, are residing in the halo.
