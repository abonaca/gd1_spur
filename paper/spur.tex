...
Many massive objects are expected to orbit the Galaxy, and should any encounter a cold stream, the perturbation remains recorded in the stream's density profile.
So, the presence of features in GD-1 is not surprising, but their intricacy is.
In this section discuss what the observed structures suggest about their origin.

- in the halo, there are known satellites (dwarf galaxies and globular cluster)
- thanks to \gaia, most of them now are fully located in the 6D phase space \citep{simon2018, gdr2_satellites}
- if we assume a potential, this means we can find their orbits and check if any came close to the gd-1 gap
- in our fiducial galaxy, none of them do, as shown in Figure~\ref{fig:known_encounters}
- true even after sampling uncertainties
...
- most probable perturber: a dark object in the halo
