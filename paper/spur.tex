...
We follow the progenitor's dissolution by releasing test particles from its Lagrange points (with the mean ejection radius of $\sim150\,\rm pc$), and produce a streakline model of the stream \citep{fardal2015}.
