...
At specific viewing angles, these stars appear off the stream track.
...
The most plausible explanation for the gap-and-spur structure is an encounter with a dark matter substructure, like those which are predicted in this mass range in this part of the Milky Way halo in \lcdm\ cosmology.
However, the inferred density of the GD-1 perturber exceeds the \lcdm\ expectations at a $2-3\,\sigma$ level.
...
Last stages of tidal disruption can result in enhanced density variations \citep[e.g., for an exoplanet disruption, see][]{}, so to fully account for all the structures observed in GD-1 we will need a full self-gravitating N-body model of the stream.
