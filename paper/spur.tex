...
% This tension opens up possibilities for new 
% Future follow-up will show whether this tension in the density of the GD-1 perturber and \lcdm\ subhalos tells us something interesting about the nature of dark matter.

% with a very small scatter of $\sim0.16\rm\, dex$ 
...
% The clustering of dark matter on small scales is one of the most pressing unknowns in cosmology and galaxy formation \citep{bullockmbk2017}.
...
% the most exciting aspect of the GD-1 features is that they demonstrate how fine-tuned instruments the cold streams are
% - with all these possibilities in store
...
% % \end{enumerate}
% 
% \gaia\ data beautifully display the information in GD-1 stream
% - hope for more
